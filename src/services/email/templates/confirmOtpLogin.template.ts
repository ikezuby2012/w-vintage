export const sendLoginOtpEmailTemplate = (firstName: string, otp: string): string => `
            ...
            <tr>
              <td style="padding: 30px">
                ...
                <p style="font-size: 14px; color: #555555; margin: 0 0 20px">
                  Here’s your verification code for signing in:
                </p>
            ...
            <tr>
              ...
              >
                <p style="font-size: 12px; color: #888888; margin: 0">
                  © ${new Date().getFullYear()} Wealth Vintage Bank. All rights reserved.
                </p>
